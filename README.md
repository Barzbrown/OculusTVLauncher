...
4. Install the launcher onto the headset:
   ...
   ```
5. In the headset, open Library → Unknown Sources and launch **ChatGPT Launcher**. The app will start a local WebXR scene, launch the Meta/Oculus Browser to `http://127.0.0.1:8765/`, and present a floating ChatGPT orb you can click to open the ChatGPT site from within VR.
